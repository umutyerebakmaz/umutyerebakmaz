document.addEventListener('DOMContentLoaded', function () {
    const container = document.getElementById('error-container'); // secicisi farkli olmalidir.
    const button = document.getElementById('dismiss-error-button'); //secisi farkli olmalidir.
